...
public class RowToInvoiceConverter {
   ...
   private static class Process {
      ...
      private Settlement mapSettlement(Row row) {
         ...
         Settlement settlement = new Settlement().setCurrency(currencyCode).addPaymentMeans(paymentMeans)
               .setPaymentReference(row.getHeader().getReference()).setMonetarySummation(calculateMonetarySummation());
      ...
      private Address mapAddress(Row.TradeParty tradeParty) {
         return new Address(tradeParty.getPostcode(), tradeParty.getAddressLine1(), tradeParty.getAddressLine2(),
               tradeParty.getCity(), tradeParty.getCountryCode());
      }
