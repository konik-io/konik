 ...
 * 
 * Try to load Konik Configuration from file `io.konik.configuration.properties`. System properties
 * provided with the +-Dio.konik*+ or ```System.setProperties("io.konik*")`` will override the file
 * content.
 * 
 */
