...
public final class Row {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equal(header, row.header) && Objects.equal(recipient, row.recipient)
        ...
        && Objects.equal(paymentReference, row.paymentReference) && Objects.equal(file, row.file);
  }
  ...
  public String toString() {
    return "Row {" + "header=" + header + ", recipient=" + recipient + ", issuer=" + issuer
        + ", items=" + items + ", comments='" + comments + '\'' + ", paymentReference='"
        + paymentReference + '\'' + ", file=" + file + '}';
  }
  ...
  public static final class Header {
    ...
    @Override
    public int hashCode() {
      return Objects.hashCode(invoiceNumber, type, issued, dueDate, note, reference, customerNumber,
          currency);
    }

    @Override
    public String toString() {
      return "Header{" + "invoiceNumber='" + invoiceNumber + '\'' + ", type='" + type + '\''
          + ", issued=" + issued + ", dueDate=" + dueDate + ", note='" + note + '\''
          + ", reference='" + reference + '\'' + ", customerNumber='" + customerNumber + '\''
          + ", currency=" + currency + '}';
    }
  }
  ...
  public static class TradeParty {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equal(name, that.name) && Objects.equal(contactName, that.contactName)
          ...
          && Objects.equal(addressLine2, that.addressLine2) && Objects.equal(city, that.city)
          && Objects.equal(postcode, that.postcode) && Objects.equal(countryCode, that.countryCode)
          && Objects.equal(email, that.email) && Objects.equal(taxes, that.taxes)
          && Objects.equal(bankInfo, that.bankInfo);
    }

    @Override
    public int hashCode() {
      return Objects.hashCode(name, contactName, addressLine1, addressLine2, city, postcode,
          countryCode, email, taxes, bankInfo);
    }

    @Override
    public String toString() {
      return "TradeParty{" + "name='" + name + '\'' + ", contactName='" + contactName + '\''
          + ", addressLine1='" + addressLine1 + '\'' + ", addressLine2='" + addressLine2 + '\''
          + ", city='" + city + '\'' + ", postcode='" + postcode + '\'' + ", countryCode="
          + countryCode + ", email='" + email + '\'' + ", taxes=" + taxes + ", bankInfo=" + bankInfo
          + '}';
    }
  }
  ...
  public static class Item {
    ...
    @Override
    public String toString() {
      return "Item {" + "type='" + name + '\'' + ", quantity=" + quantity + ", unit=" + unit
          + ", unitPrice=" + unitPrice + ", taxPercent=" + taxPercent + '}';
    }
  ...
  public static class BankInformation {
    ...
    @Override
    public String toString() {
      return "BankInformation {" + "bankName='" + bankName + '\'' + ", bic='" + bic + '\''
          + ", iban='" + iban + '\'' + '}';
    }
