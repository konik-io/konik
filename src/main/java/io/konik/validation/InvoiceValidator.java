...
public class InvoiceValidator {
  ...
  public InvoiceValidator(Validator validator) {
    super();
    this.validator = validator;
    this.monetarySummationValidator =
        new MonetarySummationValidator(new DefaultMessageInterpolator());
  }
  ...
  private void validateWithShema(Invoice invoice) throws IOException, SAXException {
    ...
    Source xmlFile =
        new StreamSource(new ByteArrayInputStream(invoiceTransformer.fromModel(invoice)));
