...
public class Agreement {
    ...
    */
	public Agreement(TradeParty sellerTradeParty, TradeParty buyerTradeParty,
	 ...
	 */
	public Agreement setBuyerTradeParty(TradeParty buyer) {
		this.buyer = buyer;
		return this;
	}
	 ...
	 * @return the supply chain trade agreement
	 */
	public Agreement setGrossPriceProduct(Price grossPrice) {
	 ...
	 * @return the supply chain trade agreement
	 */
	public Agreement setNetPriceProduct(Price netPrice) {
