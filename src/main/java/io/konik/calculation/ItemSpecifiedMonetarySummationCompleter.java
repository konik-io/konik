...
/**
 * Recalculates {@link SpecifiedMonetarySummation} for every {@link Item} and replaces old object
 * with the new one.
 */
public final class ItemSpecifiedMonetarySummationCompleter implements Correction<Invoice> {

  protected static final Logger log =
      LoggerFactory.getLogger(ItemSpecifiedMonetarySummationCompleter.class);
