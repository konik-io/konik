...
/**
 * {@link FileAppender} {@link Comparator} that uses {@code FileAppender.getPriority()} method to
 * define correct order.
 *
 * Objects with higher priority come first.
 */
public class FileAppenderPriorityComparator implements Serializable, Comparator<FileAppender> {
