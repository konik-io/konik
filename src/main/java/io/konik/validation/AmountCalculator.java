   ...
   */
   static final class ItemLineTotalCalculator implements Function<Item, Amount> {
      ...
      public Amount apply(@Nullable Item item) {
         ...
         log.debug("Line total formula: {} (net price) / {} (BasisQuantity)  x {} (quantity)", amount, basisQuantity,
               quantity);
   ...
   public static final class TaxAggregator {
      ...
      public TaxAggregator() {
         roundingMode = RoundingMode
               .valueOf(System.getProperty(this.getClass().getName() + ".RoundingMode", "HALF_UP"));
      }
